...
(function () {
    ...
    if (fabMain && fabMenu) {
        fabMain.addEventListener('click', function (e) {
            ...
            var iconOpen = fabMain.querySelector('.fab-icon-open');
            var iconClose = fabMain.querySelector('.fab-icon-close');
            if (iconOpen) iconOpen.style.display = fabOpen ? 'none' : '';
            if (iconClose) iconClose.style.display = fabOpen ? '' : 'none';
        });
